                  ...
                  db.query(deleteQuery, [userID], (err) => {
                    ...
                    db.query(orInsertQuery, [orID, uuidv4(), "宅配", "台灣", "貨到付款", orderNote, cuID, deID], (err) => {
                      ...
                      const baseParams = {
                        ...
                        TradeDesc: "購物網站商品訂購",
                        ItemName: "XX商城商品一批X1",
                        ReturnURL: "https://您的網域/payment_return", // 必填: 用於接收付款結果通知
                        PaymentType: "aio", // 必填
                        ChoosePayment: "ALL", // 必填
                        EncryptType: 1, // 必填: 加密類型
                        // 如果需要轉導到特定頁面，可以加入以下參數
                        OrderResultURL: "https://您的網域/order_result",
                      }
