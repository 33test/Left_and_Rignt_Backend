...
INSERT INTO `cart` VALUES ('10001','1',2),('10001','12',3),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','12',1),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','13',1),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','17',3),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','19',5),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','16',3),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','15',1),('d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','21',1);
...
--
-- Table structure for table `shared_cart_users`
--

DROP TABLE IF EXISTS `shared_cart_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shared_cart_users` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_shared_cart_id_idx` (`shared_cart_group_id`),
  KEY `fk_shared_cart_user_id_idx` (`user_id`),
  CONSTRAINT `fk_shared_cart_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `shared_cart_users`
--

LOCK TABLES `shared_cart_users` WRITE;
/*!40000 ALTER TABLE `shared_cart_users` DISABLE KEYS */;
INSERT INTO `shared_cart_users` VALUES (3,'1','0ba35dc8-6192-45e3-a1c9-1db6417151a4','2024-12-14 09:05:55'),(4,'1','d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','2024-12-14 09:05:55'),(5,'2','d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','2024-12-14 09:46:45'),(6,'2','c3b5bde8-e1ed-4ff9-b0f8-f672485400c9','2024-12-14 09:46:45'),(7,'2','3d4f7b36-51a7-44f2-97d9-d64298e5e2ef','2024-12-14 10:13:17'),(13,'e2463c85-beb7-421d-ad8f-f14fe1ea8fb2','10001','2024-12-15 03:04:13'),(14,'dc8a7d41-cd3d-428a-8be8-c2c5ad4929ea','10001','2024-12-15 03:15:47'),(15,'dc8a7d41-cd3d-428a-8be8-c2c5ad4929ea','d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','2024-12-15 03:15:47'),(16,'5b0093be-b71e-4395-a3e7-92f21969d408','9e3716f6-146f-4793-9d1e-ff70a34f64e6','2024-12-15 03:25:23'),(17,'5b0093be-b71e-4395-a3e7-92f21969d408','d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','2024-12-15 03:25:23'),(18,'6746c0ef-3985-40ad-b713-769a1e8aa705','c01842a5-5934-4113-a835-2c45573c252d','2024-12-15 04:21:28'),(19,'6746c0ef-3985-40ad-b713-769a1e8aa705','d9ee8caa-3dd2-4ca3-b72b-e0edfd19ae22','2024-12-15 04:21:28');
/*!40000 ALTER TABLE `shared_cart_users` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `shared_carts` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:未結帳 1:已結帳',
...
INSERT INTO `shared_carts` VALUES (3,'1','我喜歡，買給我',12,2,'2024-12-14 08:29:38','2024-12-14 12:06:47',0,NULL,NULL),(4,'1','我喜歡，買給我',15,1,'2024-12-14 08:29:38','2024-12-14 12:06:47',0,NULL,NULL),(5,'2',NULL,11,3,'2024-12-14 09:47:01','2024-12-14 09:47:01',0,NULL,NULL),(6,'2',NULL,14,5,'2024-12-14 09:47:01','2024-12-14 09:47:01',0,NULL,NULL),(7,'e2463c85-beb7-421d-ad8f-f14fe1ea8fb2','test',NULL,NULL,'2024-12-15 03:04:13','2024-12-15 03:04:13',0,NULL,NULL),(8,'dc8a7d41-cd3d-428a-8be8-c2c5ad4929ea','test',NULL,NULL,'2024-12-15 03:15:47','2024-12-15 03:15:47',0,NULL,NULL),(9,'5b0093be-b71e-4395-a3e7-92f21969d408',NULL,NULL,NULL,'2024-12-15 03:25:23','2024-12-15 03:25:23',0,NULL,NULL),(10,'6746c0ef-3985-40ad-b713-769a1e8aa705','寫到很累ㄟ誰懂',NULL,NULL,'2024-12-15 04:21:28','2024-12-15 04:21:28',0,NULL,NULL);
